      ...
      <ProjectsContainer>
        ...
        <ProjectsContents>
          ...
          <ProjectInfomation>
            ...
            <ProjectTextContainer>
              <ProjectTextTitle>
                국내 향수 커머스 사이트 PAFFEM 클론 프로젝트 입니다.
              </ProjectTextTitle>
              <p>
                짧은 프로젝트 기간동안 개발에 집중하기 위해 디자인/기획 부분만
                클론했습니다.
              </p>
              <p>
              ...
              <p>
                처음인 사람들도 설문을 통해 향수를 추천해 주는 기능이 있어
                선정했습니다.
              </p>
            </ProjectTextContainer>
            <ButtonContents>
        ...
        <ProjectsContents>
          ...
          <ProjectInfomation>
            ...
            <ProjectTextContainer>
              <ProjectTextTitle>
                국내 여행 커머스 사이트 마이리얼트립 클론 프로젝트 입니다.
              </ProjectTextTitle>
              <p>
                짧은 프로젝트 기간동안 개발에 집중하기 위해 디자인/기획 부분만
                클론했습니다.
              ...
              <p>
                이 사이트는 여행 예약 커머스 사이트로, 기능 구현은 국내 숙소로
                한해 구현했습니다.
              </p>
              <p>
                KaKao 소셜 로그인, Library 를 다양하게 사용해 볼 수 있는
                프로젝트 였습니다.
              </p>
            </ProjectTextContainer>
            <ButtonContents>
